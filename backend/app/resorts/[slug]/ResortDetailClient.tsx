...
export function ResortDetailClient({ resort }: Props) {
            ...
            <section className="mb-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {resort.amenities.map((amenity: string) => (
                  <div key={amenity} className="flex items-center gap-3 p-4 bg-white rounded-2xl border border-sand-100 shadow-sm">
                    <span className="text-gold-500">{AMENITY_ICON[amenity] ?? <CheckCircle className="w-5 h-5" />}</span>
