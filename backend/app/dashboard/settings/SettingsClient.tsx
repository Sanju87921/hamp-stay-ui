      ...
      <AnimatePresence mode="wait">
        ...
        >
          {activeTab === "verification" ? (
            <VerificationClient 
              initialStatus={ownerProfile?.status || "NOT_SUBMITTED"} 
              adminNotes={ownerProfile?.adminNotes}
            />
          ) : (
            <div className="bg-white rounded-[40px] border border-sand-200 shadow-luxury overflow-hidden">
